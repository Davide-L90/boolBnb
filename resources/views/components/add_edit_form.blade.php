{!! Form::open(['id' => $data['form_data']['id'], 'class' => $data['form_data']['class'], 'url' => $data['form_data']['action'], 'method' => $data['form_data']['method']]) !!}
    ...
    <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="title" type="text" class="form-control" name="title" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->title : null  }}">   
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('beds_number') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="beds_number" type="text" class="form-control" name="beds_number" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->beds_number : null }}">   
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('bathrooms_number') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="bathrooms_number" type="text" class="form-control" name="bathrooms_number" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->bathrooms_number : null }}">   
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('area') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="area" type="text" class="form-control" name="area" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->area : null }}">   
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="price" type="text" class="form-control" name="price" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->price : null }}">   
        </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
        ...
        <div class="col-md-9">
            <input id="address" type="text" class="form-control" name="address" value="{{ !empty($data['form_data']['apartment_details']) ? $data['form_data']['apartment_details']->address : null }}">   
        </div>
    </div>
